          ...
          <div key={index} className="mb-6 flex gap-4">
            ...
            <div className="flex-1 space-y-5">
              <div className="space-y-2">
                <div className="font-medium text-lg">{study.major}</div>
                ...
                <div className="justify-between flex flex-col flex-wrap sm:flex-row space-y-2">
                  <div className="flex flex-col sm:flex-row sm:space-x-5">
                    <div className="text-gray-500 flex items-center">
                      ...
                      <span className="font-medium">{study.school}</span>
                    </div>
                    <div className="text-gray-500 flex items-center mt-2 sm:mt-0">
                      ...
                      <span className="font-medium">{study.city}</span>
                    </div>
                  </div>
                  <div className="text-gray-500 flex items-center">
                    <svg
              ...
              <div className="text-gray-600">
                {study.information.map((info, index) => (
