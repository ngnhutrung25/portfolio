...
const ImageModal = ({ title, image }: Props) => {
    ...
    return (
        <>
            <button
                ...
                className={
                    "inline-flex items-center m-1 space-x-3 px-4 py-2 rounded-xl group border text-base font-medium transition duration-200 border-teal-600/80 hover:text-white hover:bg-teal-600/80 " +
                    (show
                        ? "text-white bg-teal-600/80"
                        : "bg-white/50 text-teal-500")
                }
                type="button"
            >
                <svg
